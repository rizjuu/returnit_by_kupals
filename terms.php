...
<body>
    ...
    <div class="form-wrapper" style="text-align: left; max-height: 85vh; overflow-y: auto;">
        <h1 style="text-align: center;">Terms and Conditions</h1>
        <p>Last updated: November 07, 2025</p>
        <p>Please read these terms and conditions carefully before using Our Service.</p>
        
        <h2>1. Acknowledgment</h2>
        <p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Campus Lost & Found. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</p>
        ...
        <h2>3. Reporting and Claiming Items</h2>
        <p>Users agree to provide truthful and accurate information when reporting a lost item or claiming a found item. Misrepresentation may result in suspension of your account.</p>
        <p>The Campus Lost & Found is not responsible for the condition of items when they are returned. We act as a facilitator to connect finders and owners.</p>
